      ...
      <div className="bg-[#0b1120] border border-slate-900 rounded-3xl p-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-[#070b13] border border-slate-900 rounded-2xl p-4 flex flex-col justify-between">
            <div>
              ...
              <p className="text-[10px] text-slate-500 mb-2">
                Modelos de contingência configurados: <code className="font-mono text-cyan-500/80">gemini-3.1-flash-lite</code>, <code className="font-mono text-cyan-500/80">gemini-flash-latest</code>, <code className="font-mono text-cyan-500/80">gemini-3.1-pro-preview</code>.
              </p>
          ...
          <div className="bg-[#070b13] border border-slate-900 rounded-2xl p-4 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs font-bold text-purple-400 font-mono text-glow">Terceira Via (Contingência)</span>
                {connectionStatus ? (
      ...
      <div className="bg-[#0b1120] border border-slate-900 rounded-3xl p-6 shadow-2xl">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center">
          <div 
            ...
            className="flex-1 w-full border-2 border-dashed border-slate-800 hover:border-cyan-500/40 rounded-2xl p-6 transition-all cursor-pointer bg-[#0e172a]/30 group text-center overflow-hidden min-h-[160px] flex items-center justify-center"
          >
            <input 
              type="file" 
              ref={fileInputRef} 
            ...
            {file ? (
              <div className="space-y-2 w-full">
                {previewUrl && file.type.startsWith('image/') ? (
                  <img src={previewUrl} alt="Preview" className="max-h-32 mx-auto rounded-lg shadow-lg border border-slate-700" />
                ) : (
                ...
                <p className="text-[10px] text-slate-500">{(file.size / 1024).toFixed(1)} KB • {file.type}</p>
                <button 
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 mt-1">PNG, JPG, WEBP ou PDF suportados</p>
                </div>
              </div>
            )}
          </div>
